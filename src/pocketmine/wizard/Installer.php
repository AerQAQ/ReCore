...
class Installer{
	const DEFAULT_NAME = "MinecraftPE: Server For ReCore";
	const DEFAULT_PORT = 14900;
...
This LICENSE is only available in Chinese.
  ...
  This core is based on an LGPL-licensed open-source project. Reselling or commercial exploitation in any form is strictly prohibited. Violators will face legal consequences.
  2. Modification Restrictions
      When modifying or creating derivative works, you are strictly prohibited from adding any backdoors, malicious code, or security-compromising functionality. All modifications must remain transparent and verifiable.
  3. Bug Reporting
  If you encounter any bugs, please report them to the developer via QQ: 3651073229. Include steps to reproduce, server environment details, and any relevant error logs.
