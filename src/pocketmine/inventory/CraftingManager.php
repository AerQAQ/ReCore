...
$this->registerRecipe((new ShapedRecipe(Item::get(Item::SUGAR, 0, 1),
	"S"
			...
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::IRON_TRAPDOOR, 0, 1),
				"PP ",
				"PP ",
				"   "
			))->setIngredient("P", Item::get(Item::IRON_INGOT, null, 4)));
			...
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::LIT_REDSTONE_TORCH, 0, 1),
				"   ",
				" R ",
				" S "
			...
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::SLAB, 7, 6),
				"XXX",
				"   ",
				"   "
			))->setIngredient("X", Item::get(Item::NETHER_BRICKS, 0, 3)));
			...
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::QUARTZ_STAIRS, 0, 4),
				...
				"PP ",
				"PPP"
			))->setIngredient("P", Item::get(Item::QUARTZ_BLOCK, 0, 6)));
			...
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::RAIL, 0 ,16),
				...
				"ISI",
				"I I"
			))->setIngredient("S", Item::get(Item::STICK, 0, 1))->setIngredient("I", Item::get(Item::IRON_INGOT, 0, 6)));
			
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::POWERED_RAIL, 0 ,6),
				"G G",
				"GSG",
				"GRG"
			))->setIngredient("S", Item::get(Item::STICK, 0, 1))->setIngredient("G", Item::get(Item::GOLD_INGOT, 0, 6))->setIngredient("R", Item::get(Item::REDSTONE_DUST, 0, 1)));
			
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::DETECTOR_RAIL, 0 ,6),
				"I I",
				"ISI",
				"IRI"
			))->setIngredient("S", Item::get(Item::STONE_PRESSURE_PLATE, 0, 1))->setIngredient("I", Item::get(Item::IRON_INGOT, 0, 6))->setIngredient("R", Item::get(Item::REDSTONE_DUST, 0, 1)));
			
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::ACTIVATOR_RAIL, 0 ,6),
				"ISI",
				"IRI",
				"ISI"
			))->setIngredient("S", Item::get(Item::STICK, 0, 2))->setIngredient("I", Item::get(Item::IRON_INGOT, 0, 6))->setIngredient("R", Item::get(Item::LIT_REDSTONE_TORCH, 0, 1)));
			
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::HOPPER, 0 ,1),
				"I I",
				"ICI",
				" I "
			))->setIngredient("C", Item::get(Item::CHEST, 0, 1))->setIngredient("I", Item::get(Item::IRON_INGOT, 0, 5)));
			
			$this->registerRecipe((new BigShapedRecipe(Item::get(Item::MAP, 0 ,1),
				"XXX",
				"XXX",
				"XXX"
			))->setIngredient("X", Item::get(Item::PAPER, 0, 1)));
		}
	}
...
*/
		...
		//SUGAR MAGMA_CREAM and RABBIT_FOOT
		$this->registerBrewingRecipe(new BrewingRecipe(Item::get(Item::SPLASH_POTION, Potion::SPEED, 1), Item::get(Item::SUGAR, 0, 1), Item::get(Item::SPLASH_POTION, Potion::AWKWARD, 1)));
		$this->registerBrewingRecipe(new BrewingRecipe(Item::get(Item::SPLASH_POTION, Potion::SPEED_T, 1), Item::get(Item::REDSTONE_DUST, 0, 1), Item::get(Item::SPLASH_POTION, Potion::SPEED, 1)));
		$this->registerBrewingRecipe(new BrewingRecipe(Item::get(Item::SPLASH_POTION, Potion::SPEED_TWO, 1), Item::get(Item::GLOWSTONE_DUST, 0, 1), Item::get(Item::SPLASH_POTION, Potion::SPEED, 1)));
		...
		$this->registerBrewingRecipe(new BrewingRecipe(Item::get(Item::SPLASH_POTION, Potion::SLOWNESS, 1), Item::get(Item::FERMENTED_SPIDER_EYE, 0, 1), Item::get(Item::SPLASH_POTION, Potion::SPEED, 1)));
		...
		$this->registerBrewingRecipe(new BrewingRecipe(Item::get(Item::SPLASH_POTION, Potion::SLOWNESS_T, 1), Item::get(Item::FERMENTED_SPIDER_EYE, 0, 1), Item::get(Item::SPLASH_POTION, Potion::SPEED_T, 1)));
		...
		//===================================================================分隔符=======================================================================
		//普通药水升级成喷溅
		foreach (Potion::$POTION_LIST as $temPotion){
			$this->registerBrewingRecipe(new BrewingRecipe(Item::get(Item::SPLASH_POTION, $temPotion, 1), Item::get(Item::GUNPOWDER, 0, 1), Item::get(Item::POTION, $temPotion, 1)));
		}
	}
	...
	protected function registerWeapons(){
		...
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::FISHING_ROD, 0, 1),
			"  S",
			" S~",
			"S ~"
		))->setIngredient("S", Item::get(Item::STICK))->setIngredient("~", Item::get(Item::STRING)));
	...
	protected function registerDyes(){
		...
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 12, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 1, 1)));
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 13, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 2, 1)));
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 7, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 3, 1)));
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 1, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 4, 1)));
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 14, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 5, 1)));
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 7, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 6, 1)));
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::DYE, 9, 2),
			"X"
		))->setIngredient("X", Item::get(Item::POPPY, 7, 1)));
